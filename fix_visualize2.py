...
# ================================
# 저장된 모델 구조 확인 후 맞게 불러오기
# ================================
print("저장된 모델 구조 확인 중...")
state_dict = torch.load("swingup_v2_baseline.pth", weights_only=True)
...
class OriginalPolicyNetwork(nn.Module):
    def __init__(self):
        ...
        self.network = nn.Sequential(
            ...
            nn.Linear(64, 2),   # 출력 2개 (왼쪽/오른쪽 확률)
            nn.Softmax(dim=-1)
        )
