...
# ================================
# 학습 때랑 완전히 동일한 PPO 신경망
# swingup_continuous.py 에서 쓴 것과 동일
# ================================
class ContinuousPolicyNetwork(nn.Module):
    def __init__(self):
        ...
        self.network = nn.Sequential(
            ...
            nn.Linear(64, 1)  # mean 출력
        )
        self.log_std = nn.Parameter(torch.zeros(1))

    def forward(self, x):
        mean = torch.tanh(self.network(x))
